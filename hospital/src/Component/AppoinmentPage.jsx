        ...
        <div className="Appoinment-background-img  pb50">
          <div className="Appointment-parent-container pt50">
            ...
            <div className="Appointment-child-container pt50">
                ...
                <div className="Appointment-input-container-5">
                  <main className="department-container">
                    <select name="Department" id="">
                      ...
                      <option value="Surgery Department">
                        Surgery Department
                      </option>
                ...
                <div className="Appointment-input-container-5">
                  <main className="time-container">
                    <select name="time" id="">
                      ...
                      <option value="01:00 PM To 02:00 PM">
                        01:00 PM To 02:00 PM{" "}
                      </option>
                      <option value="02:00 PM To 03:00 PM">
                        02:00 PM To 03:00 PM{" "}
                      </option>
                      <option value="03:00 PM To 04:00 PM">
                        03:00 PM To 04:00 PM{" "}
                      </option>
                      <option value="04:00 PM To 06:00 PM">
                        04:00 PM To 06:00 PM{" "}
                      </option>
                      <option value="06:00 PM To 08:00 PM">
                        06:00 PM To 08:00 PM{" "}
                      </option>
                      <option value="08:00 PM To 10:00 PM">
              ...
              <div className="Appointment-form-submit-button mt20">
